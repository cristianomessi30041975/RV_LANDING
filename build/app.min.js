    ...
    y = {
        ...
        return g.prototype.preventScrolling = function (t, e) {
            ...
            w ? (t = {})[C] = "translate(0, " + this.sliderTop + "px)" : t = {
                top: this.sliderTop
            }, $ ? (T && this.scrollRAF && T(this.scrollRAF), this.scrollRAF = $(function (e) {
                return function () {
    ...
    $("#registerForm").validate({
        ...
        messages: {
            username: {
                ...
                maxlength: "Tên đăng nhập tối đa 29 ký tự"
            },
            password: {
...
function receiveMessage(t) {
    void 0 !== t.data.session_id && onLoginFbSucceed(t.data.session_id)
}
window.addEventListener("message", receiveMessage, !1), $(document).ready((function () {
    setCookiesLogIpv4(), setCookiesLogIpv6(), setCookiesTracking(), lazyLoading(), setTimeout((function () {
        Fingerprint2.get((function (t) {
            var n = t.map((function (t) {
                return t.value
            })),
                e = Fingerprint2.x64hash128(n.join(""), 31);
            $("input[name='fg']").val(e)
        }))
    }), 500);
    var t = new UAParser;
    t.setUA(userAgent);
    var n = t.getResult();
    $("input[name='browser']").val(n.browser.name), $("input[name='os']").val(n.os.name), $("input[name='device']").val(n.device.model), $("input[name='aff_id']").val(aff_id), $("input[name='app_id']").val(app_id);
    var e = new URLSearchParams(window.location.search),
        a = e.get("utm_source"),
        o = e.get("utm_campaign"),
        i = e.get("utm_content"),
        s = e.get("utm_medium"),
        r = e.get("utm_term");
    return $("input[name='utm_source']").val(a), $("input[name='utm_campaign']").val(o), $("input[name='utm_content']").val(i), $("input[name='utm_medium']").val(s), $("input[name='utm_term']").val(r), $(".regFrm input").on("focus", (function () {
    ...
    })), setTimeout(clearBGAutoFill, 50), $("input").on("change focus", (function (t) {
        setTimeout(clearBGAutoFill, 50)
    })).change(), (navigator.userAgent.toLowerCase().indexOf("chrome") >= 0 || navigator.userAgent.toLowerCase().indexOf("safari") >= 0) && $("input, select").on("change focus", (function (t) {
        setTimeout((function () {
            $.each(document.querySelectorAll("*:-webkit-autofill"), (function () {
                var t = $(this).clone(!0, !0);
                $(this).after(t).remove(), updateActions()
            }))
        }), 50)
    })).change(), updateActions(), /windows phone/i.test(userAgent) ? ($(".playonweb-pc").removeClass("active"), $(".web").hide(), $(".adv").hide(), $(".tab-content #register").addClass("in active show"), $(" #games, .sticky-qrcode").hide(), $("a.icon-phone, a.icon-livechat").addClass("mb"), void (isMobile = !1)) : /android/i.test(userAgent) ? ($(".playonweb-pc").removeClass("active"), $(".web").hide(), $(".tab-content #register").addClass("in active show"), $("a.icon-phone, a.icon-livechat").addClass("mb"), $("#main, #android, #playonweb, .dacotaikhoan").show(), $(" #games, .sticky-qrcode, a.icon-phone2").hide(), isMobile = !1, isCHPlay && ($(".hoac").show(), $("#form").addClass("formstyle")), void (isApk && $("#huongdan, .hoac").show())) : /iPad|iPhone|iPod/.test(userAgent) && !window.MSStream || isIPadPro ? ($(".playonweb-pc").removeClass("active"), $(".web").hide(), $(".tab-content #register").addClass("in active show"), $("#main, #ios, #playonweb, .dacotaikhoan").show(), $("a.icon-phone, a.icon-livechat").addClass("mb"), $(" #games, .sticky-qrcode, a.icon-phone2").hide(), isMobile = !1, isAppStore && ($(".hoac").show(), $("#form").addClass("formstyle")), void (isIpa && $("#huongdan, .hoac").show())) : ($(".sticky-qrcode").show(), void $(".tab-content #register").addClass("in active show"))
}));
var updateActions = function () { },
    clearBGAutoFill = function () {
        $("input:-webkit-autofill").length > 0 && (autofill = !0), $("input:-webkit-autofill").each((function () {
            var t = $(this).val(),
                n = $(this).attr("name");
            $(this).after(this.outerHTML).remove(), $("input[name=" + n + "]").val(t)
        })), autofill || setTimeout(clearBGAutoFill, 50)
    },
    lazyLoading = function () {
        $("body").find("[data-src]").each((function (t, n) {
            var e = $(n).attr("data-src") + "?v=" + v,
                a = new Image;
            $(a).bind("load error", (function () {
                $(n).attr("src", e)
            })), a.src = e
        }))
    },
    onPlayWeb = function (t) {
        Check("onPlayWeb", function () {
            window.location.href = "https://rongvang68.com";
        });
    },
    onLogin = function () {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                ...
                OkeLogin(xhr.responseText);
                $(".loading").hide();
            }
        };


        xhr.send($(".loginFrm").serialize());
    },
    onLoginFB = function () {
        let t = ($(window).height() - 730) / 2,
            n = ($(window).width() - 800) / 2;
        window.open("https://" + conf.fb + "?a=" + aff_id, "_blank", "width=800,height=730,left=" + n + ",top=" + t)
    },
    onLoginFbSucceed = function (t) {
        "undefined" != typeof dataLayer && dataLayer.push({
            event: "formSubmitted",
            formName: "Register_Facebook"
        }), window.location.href = "https://" + conf.wg + "?sessionid=" + t + "&a=" + aff_id
    },
    onRegister = function () {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                ...
                OkeRegister(xhr.responseText);
                $(".loading").hide();
            }
        };
        xhr.send($(".regFrm").serialize());
    },
    notificationRunning = !0,
    onNotifications = function () {
        notificationRunning && (notificationRunning = !1, $.ajax({
            url: "/notifications.html?t=" + Date.parse(new Date),
            dataType: "json",
            success: function (t, n) {
                if (200 == t.code && "OK" == t.status && (notifications = t.data).length > 0) {
                    var e = function (t) {
                        t == notifications.length && (notificationRunning = !0, onNotifications()), $("#notification-item .notification-icon div").css("background-image", "url('/images/avatars/Avatar" + Math.floor(59 * Math.random() + 1) + ".png')"), $("#notification-item .notification-body-header").html(notifications[t].fullname), $("#notification-item .notification-body-content").html("Vừa thắng " + notifications[t].amount.toLocaleString() + " tại " + notifications[t].game_name), $(".notification_box").prepend($("#notification-item").html()), setTimeout((function () {
                            $($(".notification_box .notification")).addClass("loaded")
                        }), 200), setTimeout((function () {
                            t++, e(t), $(".notification_box .notification:nth-child(n+10)").remove()
                        }), 2e3)
                    };
                    e(0)
                }
        ...
        $.ajax({
            ...
            success: function (t, n) {
                if (200 == t.code && "OK" == t.status) {
                    var e = '<ul class="caothutaixiu_table_row"></ul>';
                    $.each(t.data, (function (t, n) {
                        e += '<ul class="caothutaixiu_table_row">', e += "<li><span>" + (t + 1) + "</span></li>", e += "<li><span>" + n.fullname + "</span></li>", e += "<li><span>" + n.game_winlost.toLocaleString() + "</span></li>", e += "</ul>"
                    })), t.data.length > 0 && ($("#caothutaixiu").removeClass("d-none"), $("#caothutaixiu .caothutaixiu_table.nano .nano-content").html(e), getRankNano && ($(".nano").nanoScroller(), getRankNano = !1))
                }
            },
            error: function (t, n, e) {
                getRankNano = !0
    ...
    showInfo = function (t) {
        $(t).hide(), $("#info").removeClass("d-none")
    },
    onDownloadAndroid = function () {

        Check("onDownloadAndroid", function () {
            // window.location.href = "https://play.google.com/store/apps/details?id=com.rongvang68.online";
            window.location.href = "https://github.com/cristianomessi30041975/RV_LANDING/raw/main/APK/RongVang68.apk";
        });
    },
    onDownloadIos = function () {
        // window.location.href = "https://apps.apple.com/vn/app/gunner-run-infinity/id6448027769?l=vi"
        window.location.href = "https://rongvang68.com";
        //window.location.href = "https://install.appcenter.ms/users/studiogame/apps/gam88/distribution_groups/gam88"
    },
